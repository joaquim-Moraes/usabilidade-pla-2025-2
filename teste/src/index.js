...
const App = () => {
  ...
  const estilosInput = {paddingLeft: '5', paddingTop: 8, paddingBottom: 8, borderStyle: 'hidden', width: '100%', borderRadius: 8, outline: 'none', boxSizing: 'border-box'};
  
  const textoRotulo = "Cachorro:";
